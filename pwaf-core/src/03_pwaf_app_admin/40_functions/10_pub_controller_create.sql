-- 
CREATE OR REPLACE FUNCTION pwaf_app_admin.pub_controller_create(
    in_schema text,
    in_controller_shortname text)
  RETURNS void AS
$BODY$
/**
 * @package PWAF
...
BEGIN
	...
	EXECUTE 'ALTER FUNCTION '||in_schema||'.pub_controller_about(pwaf.http_request) OWNER TO pwaf';
...
END;$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION pwaf_app_admin.pub_controller_create(text, text)
  OWNER TO pwaf;
