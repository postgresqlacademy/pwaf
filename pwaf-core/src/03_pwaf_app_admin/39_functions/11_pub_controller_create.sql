--
CREATE OR REPLACE FUNCTION pwaf_app_admin.pub_controller_create(in_schema text, in_controller_shortname text)
  RETURNS void AS
$BODY$
/**
 * @package PWAF
...
END;$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION pwaf_app_admin.pub_controller_create(in_schema text, in_controller_shortname text)
  OWNER TO pwaf;
