---
CREATE OR REPLACE FUNCTION pwaf.pub_controller_auth_security_oauth2_auth(in_request pwaf.http_request)
...
END;$BODY$
  ...
  COST 100;
ALTER FUNCTION pwaf.pub_controller_auth_security_oauth2_auth(pwaf.http_request)
  OWNER TO pwaf;
---