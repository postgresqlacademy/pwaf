...
BEGIN
	IF NOT EXISTS (
		SELECT 1 FROM pg_tables WHERE schemaname='pwaf_app_dba' and tablename='gui_layouts'
	) THEN

		CREATE TABLE pwaf_app_dba.gui_layouts
		(
...
ALTER TABLE pwaf_app_dba.gui_layouts OWNER TO pwaf;
--