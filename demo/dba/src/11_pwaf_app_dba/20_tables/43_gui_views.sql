...
BEGIN
	IF NOT EXISTS (
		SELECT 1 FROM pg_tables WHERE schemaname='pwaf_app_dba' and tablename='gui_views'
	) THEN

		CREATE TABLE pwaf_app_dba.gui_views
		(
...
ALTER TABLE pwaf_app_dba.gui_views OWNER TO pwaf;
--